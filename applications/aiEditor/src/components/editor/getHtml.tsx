...
export const myComponents: Record<string, any> = {
...
// 添加这个导出函数
export async function getEditorHtmlContent(editor: any) {
  ...
  const katexCss = `<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/katex@0.16.18/dist/katex.css" integrity="sha384-9PvLvaiSKCPkFKB1ZsEwtsz37/XrkYft3DTk2gHdYvd9oWgW3tV" crossorigin="anonymous">`;
